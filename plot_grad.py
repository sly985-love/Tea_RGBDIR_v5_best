...
def get_params():
    params = {
        'weight': '/home/ps/rgbd/result/yolov5s_best/3_best_1/weights/best.pt',
        'cfg': 'models/axiaorong/best_all.yaml',
        'device': 'cuda:0',
        'method': 'XGradCAM',  # GradCAMPlusPlus, GradCAM, XGradCAM
        'layer': 'model.model[-2]',    # -5...
        'backward_type': 'conf',  # class or conf
        'conf_threshold': 0.6,  # 0.6 zhiyouyilei
        'ratio': 0.02  # 0.02-0.1
    }
    return params
...
if __name__ == '__main__':
    ...
    model(r'img/0309-111956.png', 'result')